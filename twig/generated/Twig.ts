...
export interface TwigDef {
    append_sig: (sig: { address: string; share: string; sig: string; }, callParams: CallParams$$<'sig'>) => boolean | Promise<boolean>;
    get_random_hyper_node: (ttl: number, callParams: CallParams$$<'ttl'>) => string | Promise<string>;
    register_hyper_node: (peer_id: string, callParams: CallParams$$<'peer_id'>) => boolean | Promise<boolean>;
}
...
export interface ValidatorDef {
    read: (address: string, callParams: CallParams$$<'address'>) => { error: string; sig_share: { address: string; share: string; sig: string; }; success: boolean; } | Promise<{ error: string; sig_share: { address: string; share: string; sig: string; }; success: boolean; }>;
}
...
export type CreateSignatureArgSig = { address: string; share: string; sig: string; } 
